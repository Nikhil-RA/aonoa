...
class CameraManager {
    ...
    accessCamera() {
        ...
        .then(stream => {
            ...
            // Wait for video to load, then start auto-capture
    ...
    startAutoCapture() {
        ...
        // Then auto-capture every 5 seconds while exam is active
    ...
    captureFrame() {
        if (!this.videoFeed || !this.canvas) return;
        ...
        // Update avatar with latest frame
